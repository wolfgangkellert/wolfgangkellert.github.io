...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["events-events-module"], {
  ...
  function srcAppEventsEventsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EventsComponent_div_15_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](11, "Ciudad y Pa\xEDs:");
      ...
      if (rf & 2) {
        var event_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function EventsComponent_div_21_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 3);
      ...
      if (rf & 2) {
        var event_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function EventsComponent_div_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EventsComponent = /*#__PURE__*/function () {
      function EventsComponent(firestore) {
        ...
        value: function ngOnInit() {
          ...
          this.events.subscribe(function (event) {
            for (var i = 0; i < event.length; i++) {
              _this.eventsCollection.push(event[i]);
            }

            console.log(_this.eventsCollection);
          });
        }
      }]);
    ...
    EventsComponent.ɵfac = function EventsComponent_Factory(t) {
      return new (t || EventsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"]));
    };
  ...
  function srcAppEventsEventsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EventsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _events_routing_module__WEBPACK_IMPORTED_MODULE_2__["EventsRoutingModule"]]]
    });
